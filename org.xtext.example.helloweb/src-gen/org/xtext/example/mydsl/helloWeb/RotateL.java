 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.helloWeb.RotateL#getMilliseconds <em>Milliseconds</em>}</li>
 * </ul>
 *
...
public interface RotateL extends Command
{
   ...
   * @see org.xtext.example.mydsl.helloWeb.HelloWebPackage#getRotateL_Milliseconds()
   * @model
   * @generated
   */
  int getMilliseconds();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.helloWeb.RotateL#getMilliseconds <em>Milliseconds</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
